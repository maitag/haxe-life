...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/dead.png", __ASSET__assets_dead_png);
		type.set ("assets/dead.png", AssetType.IMAGE);
...
@:keep @:bind #if display private #end class __ASSET__assets_dead_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
//
//@:bitmap("Assets/dead.png") class __ASSET__assets_dead_png extends openfl.display.BitmapData {}
//@:bitmap("Assets/start.png") class __ASSET__assets_start_png extends openfl.display.BitmapData {}
//
//

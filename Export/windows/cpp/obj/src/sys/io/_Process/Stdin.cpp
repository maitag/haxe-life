...
{
HX_STACK_FRAME("sys.io._Process.Stdin","new",0xd3131563,"sys.io._Process.Stdin.new","D:\\Programme\\coding\\haxe\\haxe\\std/cpp/_std/sys/io/Process.hx",29,0x68543cef)
HX_STACK_THIS(this)
HX_STACK_ARG(p,"p")
{
	HX_STACK_LINE(30)

...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("lime.graphics._Renderer.RenderEventType_Impl_"), hx::TCanCast< RenderEventType_Impl__obj> ,sStaticFields,sMemberFields,
